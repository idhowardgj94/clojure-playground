...
var i_43602 = (0);
while(true){
if((i_43602 < arr.length)){
(arr[i_43602] = null);

var G__43603 = (i_43602 + (1));
i_43602 = G__43603;
continue;
} else {
}
...
var i_43624 = (self__.level + (1));
while(true){
if((i_43624 <= (new_level + (1)))){
(update[i_43624] = self__.header);

var G__43625 = (i_43624 + (1));
i_43624 = G__43625;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43628 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43628[i]));
} else {
x__$2.forward.push((((i < links_43628.length))?(links_43628[i]):null));
}

if((i < links_43628.length)){
(links_43628[i] = x__$2);
} else {
links_43628.push(x__$2);
}
...
var i_43633 = (0);
while(true){
if((i_43633 <= self__.level)){
var links_43634 = (update[i_43633]).forward;
if((x__$1 === (((i_43633 < links_43634.length))?(links_43634[i_43633]):null))){
(links_43634[i_43633] = (x__$1.forward[i_43633]));

var G__43638 = (i_43633 + (1));
i_43633 = G__43638;
continue;
} else {
var G__43639 = (i_43633 + (1));
i_43633 = G__43639;
continue;
}
} else {
...
var G__43649 = nx;
var G__43650 = (level__$1 - (1));
x = G__43649;
level__$1 = G__43650;
continue;
} else {
var G__43651 = x;
var G__43652 = (level__$1 - (1));
x = G__43651;
level__$1 = G__43652;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43655 = nx;
var G__43656 = (level__$1 - (1));
x = G__43655;
level__$1 = G__43656;
continue;
} else {
var G__43657 = x;
var G__43658 = (level__$1 - (1));
x = G__43657;
level__$1 = G__43658;
continue;
}
