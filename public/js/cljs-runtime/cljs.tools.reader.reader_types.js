...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40658 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40658(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40663 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40663(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40677 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40677(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40687 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40687(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40692 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40692(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40703 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40703(reader);
}
});
...
var G__40768 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40769 = s.append(c);
c = G__40768;
s = G__40769;
continue;
}
