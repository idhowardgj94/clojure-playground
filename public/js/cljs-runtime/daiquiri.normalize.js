...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__40506_SHARP_){
return (((p1__40506_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__40506_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40511,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__40511;
}
});
...
var len__4864__auto___40551 = arguments.length;
var i__4865__auto___40552 = (0);
while(true){
if((i__4865__auto___40552 < len__4864__auto___40551)){
args__4870__auto__.push((arguments[i__4865__auto___40552]));

var G__40553 = (i__4865__auto___40552 + (1));
i__4865__auto___40552 = G__40553;
continue;
} else {
}
break;
...
return daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});
...
var G__40513 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40513,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__40513;
}
} else {
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq40512){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40512));
}));
...
var vec__40518 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40518,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40518,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__40516_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__40516_SHARP_))){
return p1__40516_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__40517_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__40517_SHARP_))){
return daiquiri.normalize.strip_css(p1__40517_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__40543){
var vec__40544 = p__40543;
var seq__40545 = cljs.core.seq(vec__40544);
var first__40546 = cljs.core.first(seq__40545);
var seq__40545__$1 = cljs.core.next(seq__40545);
var tag = first__40546;
var content = seq__40545__$1;
...
var vec__40547 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40547,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40547,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40547,(2),null);
var tag_attrs = (function (){var G__40550 = cljs.core.PersistentArrayMap.EMPTY;
var G__40550__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40550,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40550);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40550__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__40550__$1;
}
})();
