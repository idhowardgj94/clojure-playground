...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40889 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40889(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40893 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40893(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40897 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40897(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40898 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40898(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40902 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40902(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40907 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40907(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40912 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40912(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40917 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40917(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40922 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40922(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40923 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40923(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40925 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40925(b);
}
});
